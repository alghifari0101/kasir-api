...
var produk = []Produk{
	...
	{ID: 4, Nama: "Saus Sambal ABC", Harga: 15000, Stok: 15},
	{ID: 5, Nama: "Beras Ramos 5kg", Harga: 60000, Stok: 5},
}

// in-memory storage categories
var category = []Categories{
	{ID: 1, Nama: "Makanan", Deskripsi: "Kategori makanan ringan dan berat"},
	{ID: 2, Nama: "Minuman", Deskripsi: "Kategori minuman segar dan hangat"},
	{ID: 3, Nama: "Bumbu Dapur", Deskripsi: "Kategori bumbu dan rempah-rempah"},
	{ID: 4, Nama: "Beras & Sereal", Deskripsi: "Kategori beras dan sereal"},
}
